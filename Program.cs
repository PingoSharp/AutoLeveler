        ...
        private static void OnGameLoad(EventArgs args)
        {
            ...
            switch(Player.ChampionName)
            {
                ...
                case "Jinx":
                    ...
                    break;
                case "Katarina":
                    AbilitySequence = new int[] { 0, 2, 1, 0, 0, 3, 0, 1, 0, 1, 3, 1, 1, 2, 2, 3, 2, 2 };
                    break;
                case "KogMaw":
                ...
                case "TwistedFate":
                    ...
                    break;
                case "Twitch":
                    AbilitySequence = new int[] { 2, 1, 2, 0, 2, 3, 0, 2, 0, 2, 3, 0, 0, 1, 1, 3, 1, 1 };
                    break;
                case "Vayne":
                    AbilitySequence = new int[] { 0, 1, 2, 1, 1, 3, 0, 0, 0, 0, 3, 1, 1, 2, 2, 3, 2, 2 };
                    break;
                case "Xerath":
